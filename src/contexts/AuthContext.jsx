...
export const AuthProvider = ({ children }) => {
    ...
    const login = (email, password) => {
        ...
        console.log('👥 Users in database:', users.length, users.map(u => ({ email: u.email, name: u.name })));
        ...
        console.log('✅ User found:', { name: foundUser.name, email: foundUser.email });
    ...
    const signup = (name, email, password) => {
        ...
        const newUser = { name: trimmedName, email: normalizedEmail, password: trimmedPassword };
        users.push(newUser);
        saveUsers(users);
    ...
    return (
        <AuthContext.Provider value={{ user, login, signup, logout, checkEmailExists }}>
            {children}
