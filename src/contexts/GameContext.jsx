...
export const GameProvider = ({ children }) => {
  ...
  const [progress, setProgress] = useState(() => {
    try {
      ...
      console.error(
        "❌ GameProvider: Error parsing progress from localStorage:",
        err,
      );
  ...
  useEffect(() => {
    const initLevels = async () => {
      ...
      try {
        ...
        console.log(
          "✅ GameProvider: Levels received from loadLevels:",
          loadedLevels,
        );
  ...
  useEffect(() => {
    try {
      ...
      console.error(
        "❌ GameProvider: Error saving progress to localStorage:",
        err,
      );
    }
  }, [progress]);
