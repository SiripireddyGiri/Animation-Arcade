  ...
  const handleStartGame = () => {
    if (!user) {
      ...
      window.dispatchEvent(
        new CustomEvent("aa:auth:prompt", { detail: { reason: "startGame" } }),
      );
    } else {
      ...
      <main className="landing-page">
        <section className="page-description">
          ...
          <p>
            ...
            transforms, and transitions using hands-on, cricket-themed
            challenges.
          </p>
          <button
            id="startGameBtn"
        ...
        <section className="info-section">
          ...
          <div className="steps">
            <div className="step">
              ...
              <p>
                Each level introduces a cricket-themed and CSS animation
                challenge with clear goals.
              </p>
            </div>
