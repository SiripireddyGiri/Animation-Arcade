...
const Hints = ({ level }) => {
    ...
    const renderOverlayContent = () => {
        const conceptText = level?.hints?.concept || 'Start with the basic property and its typical value pattern.';
        ...
        if (hintStage === 0) {
            return (
                <>
                    ...
                    <a href="#" className="hint-link" onClick={(e) => { e.preventDefault(); nextStage(); }}>
                        Go to Hint 2 →
                    </a>
                </>
            );
    ...
    return (
        <div className="hints">
            ...
            <div className="hint-overlay" ref={overlayRef}>
                <button className="close-btn" aria-label="Close hints" onClick={closeOverlay}>
                    ×
                </button>
